...
"LIBLIBLIBLIBLIBLIBLIBLIBLIBLIBLIBLIBLIBLIBLIBLIBLIBLIBLIBLIBLIBL"
"IBLIBLIB" // placeholder for dylib path to load
"\x00\x00\x00\x00";
#else
char code[] =
...
"LIBLIBLIBLIBLIBLIBLIBLIBLIBLIBLIBLIBLIBLIBLIBLIBLIBLIBLIBLIBLIBLIBLIBL"
"IB" // placeholder for dylib path to load
"\x00\x00\x00\x00";
#endif
...
int main(int argc, char **argv) {
  if (argc != 3) {
    ...
    fprintf(
        stderr,
        "example: ./binary /System/Applications/Books.app/Contents/MacOS/Books "
        "/tmp/xzy.dylib\n");
    exit(1);
#else
  ...
  state.__opaque_pc = ptrauth_sign_unauthenticated(
      (void *)remoteCode, ptrauth_key_function_pointer, 0);
